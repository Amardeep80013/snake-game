...
class SNAKE:
	...
	def draw_snake(self):
		self.head_update_graphic()
		self.tail_update_graphic()
		...
		# 	pygame.draw.rect(screen,(183, 111, 121), block_rect)

	def head_update_graphic(self):
...
class MAIN:
	...
	def draw_score(self):
		...
		bg_rect = pygame.Rect(apple_rect.left, apple_rect.top, apple_rect.width + score_rect.width + 6, apple_rect.width)
